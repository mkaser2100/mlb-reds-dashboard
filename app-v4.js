...
console.info("MLB Hit Lab app-v4 loaded: team-hit-board-unified-controls-v1");
...
function renderTeamBoardControls() {
  ...
  return `
    <section class="control-deck performance-window-deck team-v3-controls unified-board-controls">
      ...
      <div class="control-group grow">
        ...
        <div class="sort-pill board-scope-pill">${escapeHtml(teamGameSideLabel(selectedTeamSide))} · ranked by V3 hit probability</div>
      </div>
...
// Compatibility wrapper for any cached HTML still using the former attribute.
...
function renderMlbPredictionModeControls() {
  return `
    <section class="control-deck performance-window-deck v3-control-deck unified-board-controls">
      <div class="control-group compact-model-group">
        <div class="board-model-badge" aria-label="Active prediction model">
          <span class="board-model-icon">⭐</span>
          <span class="board-model-copy">
