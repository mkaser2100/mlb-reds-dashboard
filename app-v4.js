...
const MODEL_PERFORMANCE_FIX_VERSION = "model-performance-redesign-v4-last14-scorecard-fallback";
...
async function loadModelPerformanceData() {
  ...
  const sections = ["scorecard", "rolling", "buckets", "features"];
