    ...
    <section class="matchup-hero">
      ...
      <div class="matchup-grid">
        ...
        <article class="matchup-stat-card">
          ...
          <div class="value">${mlbTargetPitcherSplits.LHB?.batting_average_against ? fmtAvg(mlbTargetPitcherSplits.LHB.batting_average_against) : (bestPitcher?.pitcher_baa_lhb ? fmtAvg(bestPitcher.pitcher_baa_lhb) : "—")}</div>
        </article>

        <article class="matchup-stat-card">
          <div class="label">BAA vs RHB</div>
          <div class="value">${mlbTargetPitcherSplits.RHB?.batting_average_against ? fmtAvg(mlbTargetPitcherSplits.RHB.batting_average_against) : (bestPitcher?.pitcher_baa_rhb ? fmtAvg(bestPitcher.pitcher_baa_rhb) : "—")}</div>
        </article>
      </div>
    </section>
