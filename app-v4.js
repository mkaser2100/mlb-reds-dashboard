...
console.info("MLB Hit Lab app-v4 loaded: hit-board-tip-search-update-v1");
...
function renderMlbHitBoardPage(error = null) {
  ...
  content.innerHTML = `
    ...
    <section class="click-note model-drawer-tip">
      <div>
        <strong>Tip:</strong> Click any player to see why the model likes the matchup, including the strongest positive drivers, key risk factors, recent form, splits, and opposing pitcher context.
      </div>
      <span>The drawer explains the model’s confidence and the specific factors pushing the player up or down the board.</span>
    </section>
