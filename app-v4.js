...
let selectedWindow = 6;
let performanceWindow = 10;
let performanceScope = "reds";
...
function renderMlbHitBoardPerformanceSection() {
  return `
    <section class="performance-note">
      ...
      <span>Tracks the all-MLB board separately from the Reds model. No-AB players are excluded from hit-rate calculations.</span>
    </section>

    <section class="hero-grid performance-grid">
      <article class="insight-card compact">
        <div class="metric-icon">🎯</div>
        <div class="metric-label">MLB Top Pick</div>
        <div class="metric-value">${fmtRate(mlbPerformanceSummary?.top_pick_hit_rate)}</div>
        <div class="metric-sub">${fmtNum(mlbPerformanceSummary?.top_pick_abs)} AB opportunities</div>
      </article>

      <article class="insight-card compact">
        <div class="metric-icon">🥇</div>
        <div class="metric-label">MLB Top 5</div>
        <div class="metric-value">${fmtRate(mlbPerformanceSummary?.top_5_hit_rate)}</div>
        <div class="metric-sub">${fmtNum(mlbPerformanceSummary?.top_5_abs)} AB opportunities</div>
      </article>

      <article class="insight-card compact">
        <div class="metric-icon">📊</div>
        <div class="metric-label">MLB Top 20</div>
        <div class="metric-value">${fmtRate(mlbPerformanceSummary?.top_20_hit_rate)}</div>
        <div class="metric-sub">${fmtNum(mlbPerformanceSummary?.top_20_abs)} AB opportunities</div>
      </article>

      <article class="insight-card compact">
        <div class="metric-icon">🎯</div>
        <div class="metric-label">Target SP Top 5</div>
        <div class="metric-value">${fmtRate(mlbPerformanceSummary?.target_sp_top_5_hit_rate)}</div>
        <div class="metric-sub">${fmtNum(mlbPerformanceSummary?.target_sp_top_5_abs)} AB opportunities</div>
      </article>
    </section>
    ...
    <section class="board-card performance-card">
      <div class="board-header">
        <div>
          <div class="eyebrow">MLB Hit Board</div>
          <h2>Performance Summary</h2>
        </div>
        <div class="board-meta">
          <span>${fmtNum(mlbPerformanceSummary?.scored_predictions)} predictions stored</span>
          <span>${fmtNum(mlbPerformanceSummary?.ab_opportunities)} AB opportunities</span>
        </div>
      </div>
      ...
      <div class="table-wrap">
        <table class="performance-table">
          ...
          <tbody>
            <tr><td>Top Pick</td><td class="num">${fmtNum(mlbPerformanceSummary?.top_pick_abs)}</td><td class="num">${fmtRate(mlbPerformanceSummary?.top_pick_hit_rate)}</td></tr>
            <tr><td>Top 5</td><td class="num">${fmtNum(mlbPerformanceSummary?.top_5_abs)}</td><td class="num">${fmtRate(mlbPerformanceSummary?.top_5_hit_rate)}</td></tr>
            <tr><td>Top 10</td><td class="num">${fmtNum(mlbPerformanceSummary?.top_10_abs)}</td><td class="num">${fmtRate(mlbPerformanceSummary?.top_10_hit_rate)}</td></tr>
            <tr><td>Top 20</td><td class="num">${fmtNum(mlbPerformanceSummary?.top_20_abs)}</td><td class="num">${fmtRate(mlbPerformanceSummary?.top_20_hit_rate)}</td></tr>
            <tr><td>Target SP Top 5</td><td class="num">${fmtNum(mlbPerformanceSummary?.target_sp_top_5_abs)}</td><td class="num">${fmtRate(mlbPerformanceSummary?.target_sp_top_5_hit_rate)}</td></tr>
            <tr><td>All Stored MLB Predictions</td><td class="num">${fmtNum(mlbPerformanceSummary?.ab_opportunities)}</td><td class="num">${fmtRate(mlbPerformanceSummary?.hit_rate)}</td></tr>
          </tbody>
        </table>
      </div>
    </section>
    ...
    <section class="board-card performance-card">
      <div class="board-header">
        <div>
          <div class="eyebrow">MLB Rank Analysis</div>
          <h2>Top 20 Rank-by-Rank</h2>
        </div>
        <div class="board-meta">
  ...
  return `
    <section class="control-deck performance-window-deck">
      <div class="control-group">
        ...
        <div class="segmented" id="performanceScopeButtons">
          <button class="segment ${performanceScope === "reds" ? "active" : ""}" data-performance-scope="reds" type="button">Reds Hit Board</button>
          <button class="segment ${performanceScope === "mlb" ? "active" : ""}" data-performance-scope="mlb" type="button">MLB Hit Board</button>
        </div>
      </div>

      <div class="control-group grow">
        <div class="control-label">Selected View</div>
        <div class="sort-pill">${performanceScope === "reds" ? "Reds-only predictions" : "All-MLB predictions"}</div>
      </div>
    </section>
  `;
}
...
function wirePerformanceScopeButtons() {
  document.querySelectorAll("#performanceScopeButtons .segment").forEach((button) => {
    button.addEventListener("click", () => {
      const nextScope = button.dataset.performanceScope;
      if (!nextScope || nextScope === performanceScope) return;
...
function renderRedsPerformanceSection() {
  return `
    ...
    <section class="hero-grid performance-grid">
      <article class="insight-card compact">
        <div class="metric-icon">🎯</div>
        <div class="metric-label">Reds Top Pick</div>
      ...
      <article class="insight-card compact">
        <div class="metric-icon">🥇</div>
        <div class="metric-label">Reds Top 3</div>
      ...
      <article class="insight-card compact">
        <div class="metric-icon">📊</div>
        <div class="metric-label">Reds Top 5</div>
      ...
      <article class="insight-card compact">
        <div class="metric-icon">⚾</div>
        <div class="metric-label">Reds Overall</div>
    ...
    <section class="board-card performance-card">
      <div class="board-header">
        <div>
          <div class="eyebrow">Reds Score Buckets</div>
          <h2>Hit Rate by Matchup Score</h2>
        </div>
        <div class="board-meta">
    ...
    <section class="board-card performance-card">
      <div class="board-header">
        <div>
          <div class="eyebrow">Reds Prediction Rank Analysis</div>
    ...
    <section class="board-card performance-card">
      <div class="board-header">
        <div>
          <div class="eyebrow">Reds Weight Optimizer</div>
    ...
    <section class="board-card performance-card">
      <div class="board-header">
        <div>
          <div class="eyebrow">Reds Pitcher Vulnerability Analysis</div>
...
function renderPerformancePage() {
  ...
  content.innerHTML = `
    ...
    ${performanceScope === "reds" ? renderRedsPerformanceSection() : renderMlbHitBoardPerformanceSection()}
  `;

  wirePerformanceScopeButtons();
...
function showView(viewName) {
  ...
  if (viewName === "hot") {
    ...
    setText("pageSubtitle", "Reds hitter detection, recent form, and split-based matchup intelligence.");
  }
  ...
  if (viewName === "compare") {
    setText("pageEyebrow", "Experimental Model · Reduced Pitcher Weight");
    setText("pageTitle", "Experimental Board");
  ...
  if (viewName === "mlb") {
    ...
    setText("pageSubtitle", `Top hitters across MLB by today’s matchup score using the ${mlbWindow}-game window.`);
