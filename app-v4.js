...
console.info("MLB Hit Lab app-v4 loaded: performance-v3-redesign");
...
async function loadPerformanceData() {
  try {
    ...
    performanceDailyScorecardRows = dailyScorecardResult.data || [];
    performanceRollingBucketRows = rollingBucketResult.data || [];
    performanceCalibrationRows = calibrationResult.data || [];
    performanceV3CalibrationRows = v3CalibrationResult.data || [];
    performanceComponentRows = componentResult.data || [];
    performanceV2DiagnosticRows = v2DiagnosticsResult.data || [];
    performanceV3FeatureRows = v3FeaturesResult.data || [];

    // Keep legacy variables populated as fallback / drawer compatibility.
    mlbPerformanceSummary = legacySummaryResult.data || null;
    mlbRankPerformanceRows = legacyRankResult.data || [];
    mlbScoreBucketRows = legacyBucketResult.data || [];
    mlbWindowComparisonRows = legacyWindowResult.data || [];
    mlbComponentAnalysis = legacyComponentResult.data || null;
