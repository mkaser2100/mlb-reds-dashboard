...
console.info("MLB Hit Lab app-v4 loaded: matchup-summary-drawer-v1");
...
function openV3MlbDrawer(row) {
  ...
  const explanation =
    row.drawer_matchup_summary_text ||
    row.drawer_explanation_text ||
    row.explanation_text ||
    row.explanation ||
    "Detailed matchup context is not available yet.";
  ...
  body.innerHTML = `
    ...
    <section class="drawer-section v3-section matchup-summary-card">
      <div class="drawer-section-title">Matchup Summary</div>
      <p class="drawer-explanation matchup-summary-text">${escapeHtml(explanation)}</p>
      <div class="matchup-summary-note">
        Generated from the model’s strongest matchup, recent-form, opportunity, and reliability signals.
      </div>
    </section>
