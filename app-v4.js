...
console.info("MLB Hit Lab app-v4 loaded: model-performance-scorecard-ux-v1");
...
function runModelPerformanceSelfTest() {
  const checks = [
    ...
    { card: "Rolling Cache Fallback", rows: modelPerformanceData.rolling.rows.length, source: modelPerformanceData.rolling.sourceView, expectedMinimumRows: 9 },
