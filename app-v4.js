...
console.info("MLB Hit Lab app-v4 loaded: market-edge-action-pill-v5");
...
function marketEdgeActionTier(row) {
  ...
  if (isQualifiedMarketEdge(row)) {
    return { label: "Play", className: "market-tier-play", emoji: "🟢" };
  }
  if (edge >= 3) {
    return { label: "Watch", className: "market-tier-watch", emoji: "🔵" };
  }
  if (edge >= 1) {
    return { label: "Fair", className: "market-tier-fair", emoji: "⚪" };
  }
...
function renderMarketEdgeTierBadge(row) {
  ...
  return `<span class="market-action-pill ${tier.className}" title="${escapeHtml(tier.label)}"><span class="market-action-dot" aria-hidden="true"></span><span class="market-action-label">${escapeHtml(tier.label)}</span></span>`;
}
...
function ensureMarketEdgeTierStyles() {
  ...
  style.textContent = `
    ...
    .market-edge-table .market-action-label {
    ...
    .market-edge-table .market-tier-play {
      border-color: rgba(47, 214, 126, .45) !important;
      background: rgba(47, 214, 126, .13) !important;
      color: #bdf7d2 !important;
    }
    .market-edge-table .market-tier-play .market-action-dot {
      background: linear-gradient(180deg, #39ff68, #0fb84f) !important;
      box-shadow: 0 0 10px rgba(47, 214, 126, .45) !important;
    }

    .market-edge-table .market-tier-watch {
      border-color: rgba(74, 190, 255, .45) !important;
      background: rgba(74, 190, 255, .12) !important;
      color: #c7ecff !important;
    }
    .market-edge-table .market-tier-watch .market-action-dot {
      background: linear-gradient(180deg, #54b9ff, #126de6) !important;
      box-shadow: 0 0 10px rgba(74, 190, 255, .35) !important;
    }

    .market-edge-table .market-tier-fair {
      border-color: rgba(180, 190, 210, .30) !important;
      background: rgba(180, 190, 210, .10) !important;
      color: #d7deea !important;
    }
    .market-edge-table .market-tier-fair .market-action-dot {
      background: linear-gradient(180deg, #ffffff, #c7ceda) !important;
      box-shadow: 0 0 8px rgba(255,255,255,.25) !important;
    }

    .market-edge-table .market-tier-efficient {
      border-color: rgba(120, 130, 150, .25) !important;
      background: rgba(120, 130, 150, .08) !important;
      color: #aab3c5 !important;
    }
    .market-edge-table .market-tier-efficient .market-action-dot {
      background: linear-gradient(180deg, #303030, #050505) !important;
      box-shadow: inset 0 1px 0 rgba(255,255,255,.18) !important;
    }

    .qualified-market-edge-row {
      box-shadow: inset 3px 0 0 rgba(47, 214, 126, .65) !important;
    }
  `;
