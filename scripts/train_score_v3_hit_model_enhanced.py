...
def score_today(
    ...
    today = attach_matchup_features(today, matchup_df, "Today")
...
def main() -> None:
    ...
    raw = attach_matchup_features(raw, matchup_df, "Training")
    ...
    scored = score_today(client, cfg, best_model, model_run_id, matchup_df)
