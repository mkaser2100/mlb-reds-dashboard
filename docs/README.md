...
V3 is the sole recommendation model presented in the MLB Hit Board and Reds Hit Board user experiences. The application previously supported three model generations—V1, V2, and V3—but the production UI has been consolidated around V3 to reduce complexity and focus engineering effort on the strongest and most scalable model architecture.
...
2. Why V3 Is the Production Focus
3. Model Evolution and Legacy Support
...
10. Database Design
11. GitHub Actions and Daily Workflow
12. V3-Focused Roadmap
13. Current Deep Technical Reference
...
- MLB Hit Board rankings
- Reds game-specific rankings
- player-level hit probabilities
- confidence classifications
- player-detail explanations
...
# Chapter 6 – Prediction Pipeline

(Existing prediction workflow documentation retained below.)

# Chapter 7 – Evaluation & Validation
