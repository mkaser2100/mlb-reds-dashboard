...
# MLB Hit Lab V3 - Deep Technical Documentation

> **Master Technical Reference for the MLB Hit Lab V3 Prediction Engine**

This document serves as the single source of truth for the V3 architecture, feature engineering, model training, prediction pipeline, evaluation methodology, database design, and future roadmap.
...
V3 expands the MLB Hit Lab prediction engine beyond rolling baseball statistics by combining:
- Traditional rolling features
- Batter and pitcher splits
- Recent form
- Statcast contact-quality metrics
- Pitch arsenal matchup analysis

The current production model contains **110 engineered features**, an increase from **82** in the original V3 implementation.
...
This enhancement establishes the foundation for future context-aware matchup modeling while preserving backward compatibility with the original V3 rolling-window architecture.
