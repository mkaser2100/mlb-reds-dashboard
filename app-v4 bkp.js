...
console.info("MLB Hit Lab app-v4 loaded: v3-market-odds-stacked-safe-v4");
...
function renderRedsClassicRows(rows) {
  if (!rows.length) {
    return `<tr><td colspan="12" class="empty-state">No classic score hitters match the current filter.</td></tr>`;
  }
      ...
      <div class="table-wrap">
        <table>
          ...
          <tbody>
            ...
            `).join("") : `<tr><td colspan="13" class="empty-state">Loading recommended MLB hitters...</td></tr>`}
          </tbody>
        </table>
      </div>
    </section>
