...
console.info("MLB Hit Lab app-v4 loaded: v3-only-ui-focus-v5-2-last14-baseline");
...
function renderRedsMlRows(rows) {
  if (!rows.length) {
    return `<tr><td colspan="9" class="empty-state">No V3 hitters match the current filter.</td></tr>`;
  }
